 function moduleProject3() {
  ...
  function buildFooter(footerData) {
    ...
    contactEmailP.innerHTML =`Email: <a href="mailto:${footerData.contactEmail}">${footerData}</a>`
  ...
  //  ✨ do your magic here
  if(EventTarget.target === document.querySelector('section')){
    const learners = document.querySelector('.learner-card')
    learners.array.forEach(card => {
      card.classList.remove('active')
    });
  }
}
